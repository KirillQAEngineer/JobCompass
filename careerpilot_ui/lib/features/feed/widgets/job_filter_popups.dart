...
CheckedPopupMenuItem<PublicationDateFilter> _publicationDateItem({
  ...
  return CheckedPopupMenuItem<PublicationDateFilter>(
    ...
    child: Text(publicationDateLabel(value)),
  );
}

String publicationDateLabel(PublicationDateFilter value) {
  return switch (value) {
    PublicationDateFilter.anyTime => 'Publication date',
    PublicationDateFilter.last24Hours => 'Last 24 hours',
    PublicationDateFilter.last7Days => 'Last 7 days',
    PublicationDateFilter.last30Days => 'Last 30 days',
  };
}
